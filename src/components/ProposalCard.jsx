...
>
              ...
              <div id="main-heart" className="absolute -top-10 md:-top-14 text-5xl animate-bounce">💘</div>
              <img
                src={gifMessage}
                alt=""
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-pink-600 mt-4 max-w-[90%] mx-auto">
                ...
                <TypeWriter text={`${userName}, will you be my Valentine? 💖`} speed={80} />
              </h1>


              <div id="button-area" className="relative flex items-center justify-center w-full h-[150px]">
                <button
                  id="yes-button"
              ...
              <p id="cute-message" className="text-sm text-pink-500 mt-6 font-medium animate-pulse">{messages[msgIndex]}</p>
            </div>
  )
}
